...
func _run() -> void:
	...
	var ending_wordmark := load("res://assets/runtime/title/hypersonic_wordmark_v3.png") as Texture2D
	_expect(ending_wordmark != null and ending_wordmark.get_size() == Vector2(500,80), "ending title should retain the authored 500x80 HYPERSONIC wordmark", failures)
