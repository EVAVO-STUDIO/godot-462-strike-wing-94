...
func _initialize() -> void:
	...
	_expect(director_source.contains("[-0.72,-0.36,0.0,0.36,0.72]") and director_source.contains("[0.0,0.040,0.080,0.120,0.160]"), "countermeasure cassette should open into a separated five-flare fan rather than resemble an engine fire")
