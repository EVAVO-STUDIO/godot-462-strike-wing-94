...
func _initialize() -> void:
	...
	_expect(director_source.contains("[-0.92,0.84,-0.58,0.66,-0.14]") and director_source.contains("[0.94,1.08,0.80,1.16,0.88]") and director_source.contains("[0.0,0.045,0.090,0.135,0.180]") and director_source.contains("Vector2(0.60,0.60)"), "countermeasure cassette should alternate unequal port and starboard impulses into a broad staggered ten-decoy fan with readable white-hot cartridges")
