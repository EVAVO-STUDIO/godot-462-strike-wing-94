...
func _initialize() -> void:
	...
	_expect(director_source.contains("[-0.95,-0.48,0.0,0.48,0.95]") and director_source.contains("[-12.0,-6.0,0.0,6.0,12.0]") and director_source.contains("[0.0,0.040,0.080,0.120,0.160]") and director_source.contains("Vector2(0.58,0.58)"), "countermeasure cassette should open into a wide, staggered ten-decoy fan rather than resemble an engine fire")
