...
$Cases = @(
    ...
    @{ id='mode_boss_rush'; args=@('--capture-gameplay','--capture-game-mode=boss_rush','--capture-time=48','--visual-capture-delay=4.0') },
	...
	@{ id='flight_orbital_long_route'; args=@('--capture-gameplay','--capture-mission=25','--capture-time=168','--capture-throttle=84','--capture-altitude=orbital') },
	...
	@{ id='support_fighter_breakaway'; args=@('--capture-gameplay','--capture-mission=11','--capture-time=42','--capture-altitude=mid','--capture-support=fighter_breakaway') },
	...
	@{ id='support_bomber_release'; args=@('--capture-gameplay','--capture-mission=11','--capture-time=42','--capture-altitude=mid','--capture-support=bomber_release') },
	@{ id='support_bomber_egress'; args=@('--capture-gameplay','--capture-mission=11','--capture-time=42','--capture-altitude=mid','--capture-support=bomber_egress') },
	...
	@{ id='support_gunship_ingress'; args=@('--capture-gameplay','--capture-mission=11','--capture-time=42','--capture-altitude=mid','--capture-support=gunship_ingress') },
	@{ id='support_gunship_egress'; args=@('--capture-gameplay','--capture-mission=11','--capture-time=42','--capture-altitude=mid','--capture-support=gunship_egress') },
	...
	@{ id='flight_refinery_long_route'; args=@('--capture-gameplay','--capture-mission=1','--capture-time=118','--capture-throttle=75') },
	@{ id='flight_city_long_route'; args=@('--capture-gameplay','--capture-mission=15','--capture-time=145','--capture-throttle=70','--capture-altitude=low','--capture-surface-iff') },
	...
	@{ id='flight_inertial_bank_right'; args=@('--capture-gameplay','--capture-mission=0','--capture-time=42','--capture-throttle=50','--capture-steering=right','--visual-capture-delay=0.10') },
	@{ id='vx94_hard_bank_left'; args=@('--capture-gameplay','--capture-mission=0','--capture-time=42','--capture-bank=hard-left','--capture-weapon=storm_cannon','--visual-capture-delay=0.10') },
	@{ id='vx94_hard_bank_right'; args=@('--capture-gameplay','--capture-mission=0','--capture-time=42','--capture-bank=hard-right','--capture-weapon=storm_cannon','--visual-capture-delay=0.10') },
	...
	@{ id='altitude_dive_coastal_boundary'; args=@('--capture-gameplay','--capture-mission=0','--capture-time=42','--capture-altitude=high','--capture-altitude-transition=dive','--visual-capture-delay=0.52') },
	...
	@{ id='hud_boss_compact'; args=@('--capture-gameplay','--capture-mission=0','--capture-time=42','--capture-hud=boss') },
	...
	@{ id='vx94_hypersonic_cel_fold'; args=@('--capture-gameplay','--capture-cinematic=vx94_hypersonic_break','--capture-cinematic-shot=0','--visual-capture-delay=1.40') },
	@{ id='vx94_hypersonic_cel_ignition'; args=@('--capture-gameplay','--capture-cinematic=vx94_hypersonic_break','--capture-cinematic-shot=1','--visual-capture-delay=1.10') },
	@{ id='vx94_hypersonic_cel_break'; args=@('--capture-gameplay','--capture-cinematic=vx94_hypersonic_break','--capture-cinematic-shot=2','--visual-capture-delay=1.05') },
	...
	@{ id='weapon_explosion_families'; args=@('--capture-gameplay','--capture-mission=0','--capture-time=42','--capture-weapon-explosions','--visual-capture-delay=0.16') },
	...
	@{ id='weapon_bomber_precision_release'; args=@('--capture-gameplay','--capture-mission=1','--capture-time=42','--capture-form=bomber','--capture-altitude=low','--capture-bomb-flight','--visual-capture-delay=0.06') },
