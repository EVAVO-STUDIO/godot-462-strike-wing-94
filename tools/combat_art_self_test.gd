...
func _test_visual_language() -> void:
	...
	for animation_path in ["radar_site/0.png","radar_site/1.png","radar_site/2.png","radar_site/3.png","field_artillery/0.png","field_artillery/1.png","damage/0.png","damage/1.png"]:
