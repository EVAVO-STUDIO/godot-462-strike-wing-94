...
$Required = @(
    'project.godot','scenes/main.tscn','scripts/main.gd','scripts/content_catalog.gd','scripts/product_identity.gd','scripts/input_bindings.gd','scripts/startup_sequence_director.gd','scripts/startup_sequence_surface.gd','data/product_identity.json',
    ...
    'scripts/campaign_cinematic_surface.gd','scripts/campaign_cinematic_director.gd',
    ...
    'tools/product_identity_self_test.gd','tools/input_bindings_self_test.gd','tools/startup_sequence_self_test.gd','tools/campaign_cinematic_self_test.gd','tools/art_production_coverage_self_test.gd','tools/runtime_self_test.gd','tools/reward_self_test.gd','tools/service_self_test.gd','tools/mission_flow_self_test.gd','tools/pause_self_test.gd','tools/save_recovery_self_test.gd',
    ...
    'data/enemies.json','data/missions.json','data/spawn_profiles.json','data/environment_profiles.json','data/cinematics.json','data/campaign.json','data/campaign_world.json','data/player_craft.json','data/player_mounts.json',
...
$Tests = @(
    'product_identity_self_test.gd','input_bindings_self_test.gd','startup_sequence_self_test.gd','campaign_cinematic_self_test.gd','art_production_coverage_self_test.gd','runtime_self_test.gd','reward_self_test.gd','service_self_test.gd','mission_flow_self_test.gd','pause_self_test.gd','save_recovery_self_test.gd',
