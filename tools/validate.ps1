...
$Required = @(
    ...
    'scripts/craft_form_rules.gd','scripts/altitude_rules.gd','scripts/flight_speed_rules.gd','scripts/route_progress_rules.gd','scripts/craft_form_director.gd','tools/build_altitude_transition_veil.py','assets/source/environments/altitude_transition_veil_v2/manifest.json',
