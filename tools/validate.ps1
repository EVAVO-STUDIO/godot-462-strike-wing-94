...
$Tests = @(
    ...
    'strike_ordnance_self_test.gd','tech_progression_self_test.gd','boss_hud_self_test.gd','boss_signature_self_test.gd','combat_art_self_test.gd','retro_sfx_self_test.gd','afterburner_self_test.gd','hypersonic_self_test.gd','countermeasure_self_test.gd','player_mount_self_test.gd'
)
