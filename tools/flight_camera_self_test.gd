...
func run() -> void:
	...
	check(art_source.contains("func _altitude_craft_scale") and art_source.contains("depth_pulse*0.07") and art_source.contains("depth_pulse*0.06"), "climb and dive art should carry restrained opposing depth scale pulses")
