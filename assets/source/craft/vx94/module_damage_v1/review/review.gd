extends SceneTree
const BASE:="C:/Gitrepos/godot-462-strike-wing-94/work/vx94_module_damage_v1/"
class Surface extends Node2D:
	var texture:Texture2D
	var label:String
	func _draw()->void:
		draw_rect(Rect2(0,0,640,360),Color("15212b"))
		draw_string(ThemeDB.fallback_font,Vector2(20,24),"VX-94 / MODULE DAMAGE / ART FIXTURE",HORIZONTAL_ALIGNMENT_LEFT,-1,16)
...
func review()->void:
	...
	print("VX94_STORES_NATIVE: 60 localized module-damage states captured")
	quit()
