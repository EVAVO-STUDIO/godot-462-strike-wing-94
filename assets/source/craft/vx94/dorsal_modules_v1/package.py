...
r=Path.cwd();b=r/'work/vx94_dorsal_modules_v1';d=r/'assets/source/craft/vx94/dorsal_modules_v1';d.mkdir(parents=True,exist_ok=True);(d/'.gdignore').write_text('')
...
shutil.copy2(r/'work/build_vx94_dorsal_modules_v1.mjs',d/'build_vx94_dorsal_modules_v1.mjs');(d/'originals').mkdir(exist_ok=True)
