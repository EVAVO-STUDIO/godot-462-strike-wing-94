...
const FRAMES := {
	...
	,"hypersonic_engine_ring": [preload("res://assets/runtime/effects/persistent/hypersonic_engine_ring/0.png"), preload("res://assets/runtime/effects/persistent/hypersonic_engine_ring/1.png"), preload("res://assets/runtime/effects/persistent/hypersonic_engine_ring/2.png"), preload("res://assets/runtime/effects/persistent/hypersonic_engine_ring/3.png"), preload("res://assets/runtime/effects/persistent/hypersonic_engine_ring/4.png"), preload("res://assets/runtime/effects/persistent/hypersonic_engine_ring/5.png")]
}
